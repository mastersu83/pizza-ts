...
const Cart = () => {
  ...
  const { basketPizza, totalSum, totalCount } = useAppSelector(
    (state) => state.basket
  );
        ...
        <div className={classes.cart}>
          ...
          <div className={classes.cart__bottom}>
            ...
            <div className={classes.cart__bottom_buttons}>
              <Link
                to="/"
                className={`${commonClasses.button} ${commonClasses.button__outline} ${commonClasses.button__add} ${classes.go_back_btn}`}
              >
                <svg
                  width="8"
                  height="14"
              ...
              <div className={`${commonClasses.button} ${classes.pay_btn}`}>
